...
"""
    ...
    Quand je sélectionne la catégorie StorageRule pour l'unité 1_Saint Denis Université
    Alors la catégorie contient 0 règles et 1 propriétés héritées
    Et la catégorie contient une propriété FinalAction héritée depuis l'unité 1_Saint Denis Université avec pour métadonnées
	| PropertyValue         | Copy                                              |
	| OriginatingAgency     | RATP                                              |
	| Paths.array[][]       | [["{{unit:1_Saint Denis Université}}"]]           |

    Quand je sélectionne la catégorie AccessRule pour l'unité 1_Saint Denis Université
    Alors la catégorie contient 1 règles et 0 propriétés héritées
    Et la catégorie contient une règle ACC-00002 héritée depuis l'unité 1_Saint Denis Université avec pour métadonnées
	| StartDate             | "2000-01-01"                                      |
	| EndDate               | "2025-01-01"                                      |
	| Paths.array[][]       | [["{{unit:1_Saint Denis Université}}"]]           |

    Quand je sélectionne la catégorie AppraisalRule pour l'unité 1_Saint Denis Université
    Alors la catégorie contient 0 règles et 1 propriétés héritées
    Et la catégorie contient une propriété FinalAction héritée depuis l'unité 1_Saint Denis Université avec pour métadonnées
	| PropertyValue         | Keep                                              |
	| OriginatingAgency     | RATP                                              |
    ...
    Quand je sélectionne la catégorie ClassificationRule pour l'unité 1_Saint Denis Université
    Alors la catégorie contient 1 règles et 5 propriétés héritées
    Et la catégorie contient une propriété ClassificationLevel héritée depuis l'unité 1_Saint Denis Université avec pour métadonnées
	| PropertyValue         | Confidentiel D\u00E9fense                         |
	| OriginatingAgency     | RATP                                              |
	| Paths.array[][]       | [["{{unit:1_Saint Denis Université}}"]]           |
	Et la catégorie contient une propriété ClassificationOwner héritée depuis l'unité 1_Saint Denis Université avec pour métadonnées
    | PropertyValue         | ClassificationOwner0                              |
    | OriginatingAgency     | RATP                                              |
    | Paths.array[][]       | [["{{unit:1_Saint Denis Université}}"]]           |
    Et la catégorie contient une propriété ClassificationAudience héritée depuis l'unité 1_Saint Denis Université avec pour métadonnées
    | PropertyValue         | ClassificationAudience0                           |
    | OriginatingAgency     | RATP                                              |
    | Paths.array[][]       | [["{{unit:1_Saint Denis Université}}"]]           |
    Et la catégorie contient une propriété NeedReassessingAuthorization héritée depuis l'unité 1_Saint Denis Université avec pour métadonnées
    | PropertyValue         | true                                              |
    | OriginatingAgency     | RATP                                              |
    | Paths.array[][]       | [["{{unit:1_Saint Denis Université}}"]]           |
    Et la catégorie contient une propriété ClassificationReassessingDate héritée depuis l'unité 1_Saint Denis Université avec pour métadonnées
    | PropertyValue         | 2016-06-03                                        |
    | OriginatingAgency     | RATP                                              |
    | Paths.array[][]       | [["{{unit:1_Saint Denis Université}}"]]           |

    Quand je sélectionne la catégorie DisseminationRule pour l'unité 1_Saint Denis Université
    Alors la catégorie contient 0 règles et 0 propriétés héritées

    Quand je sélectionne la catégorie ReuseRule pour l'unité 1_Saint Denis Université
    Alors la catégorie contient 0 règles et 0 propriétés héritées
