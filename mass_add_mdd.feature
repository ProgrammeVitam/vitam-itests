  ...
  ### Ajouter ###
   ...
   ### Cas KO d'ajout avec un mauvais type ###
    ...
    Scénario: Ajouter une métadonnée descriptive - MyDouble Cas 1 : [MyDouble = string]
      Quand j'utilise le fichier de requête suivant data/queries/mass-update/mass_modif_add_myDouble_string_ko.json
      Et je lance la mise à jour de masse des units
      Alors le statut final du journal des opérations est KO

    Scénario: Ajouter une métadonnée descriptive - MyDouble Cas 2 : ["MyDouble [Array 1]", "MyDouble [Array 2]"]
      Quand j'utilise le fichier de requête suivant data/queries/mass-update/mass_modif_add_myDouble_array_ko.json
      Et je lance la mise à jour de masse des units
      Alors le statut final du journal des opérations est KO

    Scénario: Ajouter une métadonnée descriptive - MyDouble Cas 3 : [MyDouble = "2016-10-12T16:28:40"]
      Quand j'utilise le fichier de requête suivant data/queries/mass-update/mass_modif_add_myDouble_dateNorme_ko.json
      Et je lance la mise à jour de masse des units
      Alors le statut final du journal des opérations est KO

    Scénario: Ajouter une métadonnée descriptive - MyDouble Cas 4 : [MyDouble = "2016/10/12"]
      Quand j'utilise le fichier de requête suivant data/queries/mass-update/mass_modif_add_myDouble_date_ko.json
      Et je lance la mise à jour de masse des units
      Alors le statut final du journal des opérations est KO

    Scénario: Ajouter une métadonnée descriptive - MyDouble Cas 5 : [MyDouble = "true"]
      Quand j'utilise le fichier de requête suivant data/queries/mass-update/mass_modif_add_myDouble_boolean_ko.json
      Et je lance la mise à jour de masse des units
      Alors le statut final du journal des opérations est KO
